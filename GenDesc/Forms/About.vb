Public Partial Class About
	...
	Sub AboutLoad(sender As Object, e As EventArgs)
		...
		Me.WriteItemLink(sw, "Creator", "http://gendesc.codeplex.com/", "GenDesc Team")
		...
		sw.WriteLine("This application uses <a href=""http://www.gnu.org/licenses/gpl-2.0.html"" target=""_blank"">GNU General Public License version 2 (GPLv2)</a> license.")
		sw.WriteLine("</div>")
		sw.WriteLine("</div>")		
